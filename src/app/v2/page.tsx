  ...
  return (
    <header
      ...
      style={{
        ...
        borderBottom: "1px solid rgba(168,230,163,0.08)",
      }}
    >
...
function MissionBar() {
  ...
  return (
    <section
      style={{
        background: "#0A1C10",
        borderTop: "1px solid rgba(168,230,163,0.1)",
        borderBottom: "1px solid rgba(168,230,163,0.1)",
      }}
    >
...
function FinalCTA() {
  return (
    <section className="relative py-36 overflow-hidden">
      <Image
        src="https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=1600&q=80"
        alt="Dog looking into the distance"
        fill
        className="object-cover"
      />
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-sm text-center" style={{ color: "rgba(255,255,255,0.26)" }}>
